    ...
    this.FilmRoll = (function () {
        ...
        FilmRoll.prototype.configure = function () {
            ...
            if (!(this.options.no_css === true || document.film_roll_styles_added)) {
                $("<style type='text/css'>.film_roll_wrapper{display:block;text-align:center;float:none;position:relative;top:auto;right:auto;bottom:auto;left:auto;z-index:auto;width:100%;height:100%;margin:0 !important;padding:0 !important;overflow:hidden;}.film_roll_shuttle{text-align:left;float:none;position:relative;top:0;left:0;right:auto;bottom:auto;height:100%;margin:0 !important;padding:0 !important;z-index:auto;}.film_roll_shuttle.vertical_center:before{content:'';display:inline-block;height:100%;vertical-align:middle;margin-right:-0.25em;}.film_roll_child{position:relative;display:inline-block;*display:inline;vertical-align:middle;zoom:1;margin: 0 5px;}.film_roll_prev,.film_roll_next{position:absolute;top:45%;left:15px;}.film_roll_prev:hover,.film_roll_next:hover{opacity:0.5}.film_roll_next{left:auto;right:15px}.film_roll_pager{text-align:center;margin:20px 0;}.film_roll_pager a{width:5px;height:5px;border:2px solid #ccc;background-color:#ccc;border-radius:5px;display:inline-block;margin:0 5px 0 0;transition:all 1s ease}.film_roll_pager a:hover{background:#c00;border:2px solid #c00;}.film_roll_pager a.active{background:#cc0000;border:2px solid #c00;}.film_roll_pager span{display:none}.film_roll_pager a,a.film_roll_prev,a.film_roll_next{-webkit-box-sizing: content-box;-moz-box-sizing: content-box;box-sizing: content-box;}</style>").appendTo('head');
            ...
            if (this.options.prev && this.options.next) {
                ...
                this.wrapper.append('<a class="film_roll_prev" href="#"><img src="http://coto-mono-michi.sub.jp/store/pc/top/left.png"></a>');
                this.wrapper.append('<a class="film_roll_next" href="#"><img src="http://coto-mono-michi.sub.jp/store/pc/top/right.png"></a>');
