...
<div class="">
	...
	<?
		if($_COOKIE["cart"] == ""){
			...
			for($cart_count = 0 ; $cart_count < count($cart) ; ++$cart_count){
				...
				$sql_cart = "select item_id , item_price , item_stock ,item_photo from item where item_id=".$item[0];
	...
	?>
			<tr>
				...
				<td><button type="button" class="btn btn-primary" onclick="">结帐</button></td></tr>
	<?
		}
	?>
	</table>
