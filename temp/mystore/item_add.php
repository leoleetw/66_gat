...
<div id="add_item_div" class='col-lg-12'>
	<form id="add_item_form" action="ajax/item.php" method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="keyIn_wrapper">
				...
				<div class='col-lg-10 keyIn_underline'><input type="text" class="form-control" id="item_name" name="item_name" value="" ></div>
			</div>
		</div>
		<div class="row">
			<div class="keyIn_wrapper">
				...
				<div id="item_cate_child" class='col-lg-2'></div>
		...
		<div class="row">
			<div class="keyIn_wrapper">
				...
				<div class='col-lg-2 keyIn_underline'><input type="text" class="form-control" id="item_stock" name="item_stock" value="" placeholder='999内' onchange="if(isNaN(this.value)){alert('只能填写数字');this.value='';this.focus();};"></div>
				<div class='col-lg-2 col-lg-offset-2' style="text-align:right;"><font style="color:red">＊</font><font class="keyIn_text">商品价格︰</font></div>
				<div class='col-lg-4 keyIn_underline'><input type="text" class="form-control" id="item_price" name="item_price" value="" onchange="if(isNaN(this.value)){alert('只能填写数字');this.value='';this.focus();};"></div>
			</div>
		</div>
		<div class="row">
			<div class="keyIn_wrapper">
				<div class='col-lg-2' style="text-align:right;"><font style="color:red">＊</font><font class="keyIn_text">商品照片︰<br><h6>(上限4张)</h6></font></div>
				<div class="col-lg-10">
					<input type='hidden' id='item_photo_count' name='item_photo_count' value='1'>
					<div id="add_photo_div" class="selectBtn"><input type="file" id="item_photo1" name="item_photo[]" accept="image/*"></div>
				...
				<div class='col-lg-10'>
					<div class="row">
						<table class="table table-bordered">
							<tr>
								<td><font>尺寸︰</font></td><td><div class="keyIn_underline"><input type="text" class="form-control" id="item_size" name="item_size" value="" placeholder='20字内描述'></div></td>
								<td><font>产地︰</font></td><td><div class="keyIn_underline"><input type="text" class="form-control" id="item_origin" name="item_origin" value="" placeholder='20字内描述'></div></td>
							</tr>
							<tr>
								<td><font>重量︰</font></td><td><div class="keyIn_underline"><input type="text" class="form-control" id="item_weigth" name="item_weigth" value="" placeholder='20字内描述'></div></td>
								<td><font>包装尺寸︰</font></td><td><div class="keyIn_underline"><input type="text" class="form-control" id="package_size" name="package_size" value="" placeholder='20字内描述'></div></td>
							</tr>
							<tr><td><font>注意事项︰</font></td><td colspan='3'><div class="keyIn_underline"><textarea class="form-control" id="item_note" name="item_note" placeholder='50字内描述'></textarea></div></td></tr>
						</table>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="keyIn_wrapper">
				...
				<div class='col-lg-10 textarea_under'><textarea class="textarea form-control" id="item_html" name="item_html" style="width:100%;height:500px;"></textarea></div>
			</div>
		</div>
		<div class="row">
